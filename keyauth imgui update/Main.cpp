...
int APIENTRY WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    ImFont* IconFont = io.Fonts->AddFontFromMemoryTTF(&font, sizeof font, 20, nullptr, io.Fonts->GetGlyphRangesCyrillic());
    ImFont* f1 = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Arialbd.ttf", 16);
    ImFont* f2 = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Arialbd.ttf", 13);
    ImFont* f3 = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Arialbd.ttf", 12);
    ImFont* f4 = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Ariblk.ttf", 24);
    ImFont* f5 = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Arialbd.ttf", 8);
    //Florsn
//ImFont* f6 = io.Fonts->AddFontFromFileTTF("C:\\Config\\Florsn33.ttf", 24.0f);
//ImFont* f7 = io.Fonts->AddFontFromFileTTF("C:\\Config\\Florsn33.ttf", 13.0f);
//ImFont* f8 = io.Fonts->AddFontFromFileTTF("C:\\Config\\Florsn33.ttf", 16.0f);
//ImFont* f10 = io.Fonts->AddFontFromFileTTF("C:\\Config\\Florsn33.ttf", 20.0f);
            //Argentum Normal
    ImFont* f6 = io.Fonts->AddFontFromFileTTF("C:\\Config\\argentum-sans.bold-italic.ttf", 24.0f);
    ImFont* f7 = io.Fonts->AddFontFromFileTTF("C:\\Config\\argentum-sans.bold.ttf", 13.0f);
    ImFont* f8 = io.Fonts->AddFontFromFileTTF("C:\\Config\\argentum-sans.bold.ttf", 16.0f);
    ImFont* f10 = io.Fonts->AddFontFromFileTTF("C:\\Config\\argentum-sans.bold.ttf", 20.0f);
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        ImGui::NewFrame();
        {
            ...
            if (config.Includes.showing)
            {
                ...
                ImGui::Begin("Peak.gg rust script", &loader_active, window_flags);
                {
                    {//Draw Line
                    ...
                    {//Tabs
                        ImGui::BeginGroup();
                        {
                            ...
                            ImGui::TextColored(ImColor(45, 45, 45, 255), " ");
                            ImGui::PopFont();
                            ImGui::SameLine();
                            ImGui::PushFont(f6);
                            ImGui::TextColored(ImColor(255, 255, 255), "Skeng");
                            ImGui::SameLine(105);
                            ImGui::TextColored(ImColor(230, 10, 93), ".uk");
                            ImGui::PopFont();
                            ...
                            if (ImGui::Tab(("main"), config.Includes.currentColumn == 1)) config.Includes.currentColumn = 1; ImGui::SameLine();
                            if (ImGui::Tab(("keys"), config.Includes.currentColumn == 2)) config.Includes.currentColumn = 2; ImGui::SameLine();
                    ...
                    {//Script
                        ...
                        case 0:
                            ...
                            ImGui::BeginChildss("##scriptinfo", ImVec2(217.5, 248 + 25));
                            {
                                ImGui::BeginGroup();
                            ...
                            ImGui::BeginChildss("##loaderinfo", ImVec2(217.5, 248 + 25));
                            {
                                ImGui::BeginGroup();
                        ...
                        case 1:
                            ...
                            ImGui::SetCursorPos(ImVec2(5, 45));
                            ImGui::BeginChildss("##recoil", ImVec2(217.5, 248 + 25));
                            {
                                ImGui::BeginGroup();
                                ...
                                ImGui::Checkbox("enable autodetection (beta)", &config.Includes.autodetect);
                                ImGui::Checkbox("enable legitmode", &config.Includes.legitmode);
                                ImGui::Checkbox("enable hipfire", &config.Includes.hipfire);
                            ...
                            ImGui::SetCursorPos(ImVec2(227.5, 45));
                            ImGui::BeginChildss("##recoil1", ImVec2(217.5, 248 + 25));
                            {
                                ImGui::BeginGroup();
                        ...
                        case 2:
                            ...
                            ImGui::SetCursorPos(ImVec2(5, 45));
                            ImGui::BeginChildss("##keys", ImVec2(217.5, 248 + 25));
                            {
                                ImGui::BeginGroup();
                            ...
                            ImGui::SetCursorPos(ImVec2(227.5, 45));
                            ImGui::BeginChildss("##keys1", ImVec2(217.5, 248 + 25));
                            {
                                ImGui::BeginGroup();
                        ...
                        case 3:
                            ImGui::SetCursorPos(ImVec2(5, 45));
                            ImGui::BeginChildss("##configs", ImVec2(440, 248 + 25));
                            {
                                ImGui::BeginGroup();

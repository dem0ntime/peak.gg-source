...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    else if (*v)
    {
        ...
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(pad, pad), check_bb.Max - ImVec2(pad, pad), ImU32(ImColor(230, 10, 93, 255)), 3.0f, 15);
...
bool ImGui::Tab(const char* label, bool selected)
{
    ...
    draw->AddRectFilled(ImVec2(bb.Min.x, bb.Max.y - 2), bb.Max, ImColor(230, 10, 93, a));
